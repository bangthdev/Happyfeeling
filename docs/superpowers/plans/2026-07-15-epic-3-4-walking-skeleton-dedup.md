...
Verify bằng PR test thật (#30, `nhd98z2/Happyfeeling`), fixture 4 lỗi cố ý (`scripts/aic34-verify-fixture.js`, đã xoá trước khi đóng PR) — dùng chung cách tự dựng request HMAC hợp lệ như AIC-31 (GitHub App vẫn thuộc account Bằng, không đổi được webhook URL sang môi trường local).
