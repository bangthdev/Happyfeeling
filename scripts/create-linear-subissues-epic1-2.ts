...
const PLAN_PATH = 'docs/superpowers/plans/2026-07-13-epic-1-2-monorepo-db-scaffold.md';
...
const SUB_ISSUES: SubIssueDef[] = [
  {
    key: 'task1',
    title: 'nhd98z2/AIC-17-pnpm-workspace-skeleton',
  ...
  {
    key: 'a1',
    title: 'nhd98z2/AIC-18-cutover-src-to-packages-github',
    parentEpicTitle: 'Epic 1: Monorepo Scaffold',
    description:
  ...
  {
    key: 'a2',
    title: 'nhd98z2/AIC-19-apps-web-empty-shell',
    parentEpicTitle: 'Epic 1: Monorepo Scaffold',
    description:
  ...
  {
    key: 'a3',
    title: 'nhd98z2/AIC-20-docker-compose',
    parentEpicTitle: 'Epic 1: Monorepo Scaffold',
    description:
  ...
  {
    key: 'b1',
    title: 'nhd98z2/AIC-21-prisma-schema-scaffold',
  ...
  {
    key: 'b2',
    title: 'nhd98z2/AIC-22-migrate-local-postgres',
    parentEpicTitle: 'Epic 2: Database & Schema',
    description:
  ...
  {
    key: 'b3',
    title: 'nhd98z2/AIC-23-seed-script',
    parentEpicTitle: 'Epic 2: Database & Schema',
    description:
  ...
  {
    key: 'task5',
    title: 'nhd98z2/AIC-24-integration-check',
    parentEpicTitle: 'Epic 2: Database & Schema',
    description:
...
async function main() {
  ...
  for (const epicTitle of ['Epic 1: Monorepo Scaffold', 'Epic 2: Database & Schema']) {
    const id = await findIssueIdByTitle(teamId, epicTitle);
    if (!id) {
      throw new Error(`Không tìm thấy epic cha "${epicTitle}" trên Linear — kiểm tra lại đã tạo 12 epic chưa.`);
    }
